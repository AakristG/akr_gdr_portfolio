...
export default function Blog() {
  ...
  return (
    <StaggerParent className="mx-auto my-0 w-full max-w-[42em]">
      <h1 className="mb-20 text-2xl leading-[1.3] md:text-4xl">
        ...
        return (
          ...
          >
            <div className="h-full w-full rounded-lg bg-background py-4 px-8 dark:bg-d-background">
              <h2 className=" mb-4 mt-6 font-sans text-xl leading-[1.3] md:text-3xl">
                <Link prefetch="render" to={post.slug}>
                  {post.title}
                </Link>
              </h2>
              <p className="my-6 md:text-xl font-roboto">{post.description}</p>
